...
-- AddForeignKey
ALTER TABLE "TeamMemberships" ADD CONSTRAINT "TeamMemberships_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "Teams"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TeamMemberships" ADD CONSTRAINT "TeamMemberships_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
